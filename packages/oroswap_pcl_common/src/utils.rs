...
use oroswap::asset::{Asset, AssetInfo, Decimal256Ext, DecimalAsset};
...
#[cfg(any(feature = "injective", feature = "sei", feature = "zigchain"))]
...
where
    C: CustomQuery,
{
    oroswap_factory::state::PAIRS
        .query(&querier, factory.clone(), &pair_key(asset_infos, &config.pair_info.pair_type))
