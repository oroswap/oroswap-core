        ...
        QueryC: CustomQuery + DeserializeOwned + 'static,
    {
        ...
        match type_url.as_str() {
            ...
            MsgPlaceLimitOrder::TYPE_URL => {
                ...
                // Escrow tokens
                let value = MsgPlaceLimitOrder::decode(value.as_slice())?;
            ...
            MsgCancelLimitOrder::TYPE_URL => {
                let cancel_msg = MsgCancelLimitOrder::decode(value.as_slice())?;
                let order = self
                    .orders
                    .borrow_mut()
        ...
        match request.path.as_str() {
            ...
            "/neutron.dex.Query/SimulateCancelLimitOrder" => {
                ...
                let resp = Some(MsgCancelLimitOrderResponse {
                    taker_coin_out: None,
                    maker_coin_out: Some(neutron_std::types::cosmos::base::v1beta1::Coin {
                        denom: order.token_in,
