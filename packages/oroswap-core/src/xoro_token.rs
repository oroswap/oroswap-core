...
/// This structure describes the parameters used for creating a xORO token contract.
#[cw_serde]
...
pub enum QueryMsg {
    ...
    TokenInfo {},
    /// Returns who can mint xORO and the hard cap on maximum tokens after minting.
    ...
    /// AllAccounts returns all the accounts that have xORO balances. Supports pagination.
