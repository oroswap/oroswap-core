...
/// # use oroswap_core::asset::AssetInfo::{NativeToken, Token};
/// NativeToken { denom: "uusd".to_string() };
/// Token { contract_addr: Addr::unchecked("contract") };
/// ```
#[cw_serde]
pub struct Asset {
...
/// This structure stores the main parameters for an Oroswap pair
#[cw_serde]
pub struct PairInfo {
