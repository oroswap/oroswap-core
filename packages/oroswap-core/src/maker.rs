...
pub struct DevFundConfig {
    ...
    pub share: Decimal,
    /// Asset that devs want ORO to be swapped to
...
pub struct Config {
    ...
    /// The xORO staking contract address.
    ...
    /// The vxORO fee distributor contract address
    pub governance_contract: Option<Addr>,
    /// The percentage of fees that go to the vxORO fee distributor
    pub governance_percent: Uint64,
    /// The ORO token asset info
    pub oro_token: AssetInfo,
    /// The max spread allowed when swapping fee tokens to ORO
    pub max_spread: Decimal,
    /// The flag which determines whether accrued ORO from fee swaps is being distributed or not
    pub rewards_enabled: bool,
    /// The number of blocks over which ORO that accrued pre-upgrade will be distributed
    pub pre_upgrade_blocks: u64,
    /// The last block until which pre-upgrade ORO will be distributed
    pub last_distribution_block: u64,
    /// The remainder of pre-upgrade ORO to distribute
    pub remainder_reward: Uint128,
    /// The amount of collected ORO before enabling rewards distribution
...
pub struct InstantiateMsg {
    ...
    /// The xORO staking contract address. If None then governance_contract must be set with 100% fee.
    pub staking_contract: Option<String>,
    /// The governance contract address (fee distributor for vxORO)
    ...
    /// The maximum spread used when swapping fee tokens to ORO
...
#[cw_serde]
pub enum ExecuteMsg {
    /// Collects and swaps fee tokens to ORO
    Collect {
        /// The assets to swap to ORO
    ...
    /// Distribute ORO to stakers and to governance
    DistributeOro {},
...
pub struct ConfigResponse {
    ...
    /// The dev fund configuration
    pub dev_fund_conf: Option<DevFundConfig>,
    /// The governance contract address (fee distributor for vxORO stakers)
    pub governance_contract: Option<Addr>,
    /// The percentage of fees that go to governance_contract
    pub governance_percent: Uint64,
    /// The maximum spread used when swapping fee tokens to ORO
    pub max_spread: Decimal,
    /// The remainder ORO tokens (accrued before the Maker is upgraded) to be distributed to xORO stakers
    pub remainder_reward: Uint128,
    /// The amount of ORO tokens accrued before upgrading the Maker implementation and enabling reward distribution
    pub pre_upgrade_oro_amount: Uint128,
    /// Parameters that describe the second receiver of fees
    pub second_receiver_cfg: Option<SecondReceiverConfig>,
    /// List of authorized keepers who can call collect
...
/// This struct holds parameters to help with swapping a specific amount of a fee token to ORO.
#[cw_serde]
