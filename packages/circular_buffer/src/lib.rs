//! # Circular Buffer
//! 
//! A circular buffer implementation for storing time series data in CosmWasm contracts.
//! 
//! ## Example
//! 
//! ```rust
//! // extern crate serde;
//! // use oroswap_circular_buffer::{BufferManager, CircularBuffer};
...
//! // const BUFFER: CircularBuffer<PricePoint> = CircularBuffer::new("buffer_state", "buffer");
//! 
//! // // Initialize the buffer
//! // BufferManager::init(&mut store, BUFFER, 3).unwrap();
//! 
//! // // Create a buffer manager
//! // let mut buffer = BufferManager::new(&store, BUFFER).unwrap();
//! 
//! // // Push a value
...
//! //     timestamp: 1,
//! // };
//! // buffer.push(&price_point);
//! 
//! // // Commit to storage
//! // buffer.commit(&mut store).unwrap();
//! 
//! // // Read the value back
//! // let values = buffer.read(&store, vec![0u32], false).unwrap();
//! // assert_eq!(values.len(), 1);
//! // assert_eq!(values[0], price_point);
//! ```
