...
use oroswap::asset::{determine_asset_info, Asset, AssetInfo, AssetInfoExt};
use oroswap::incentives::{QueryMsg, RewardType, ScheduleResponse, MAX_PAGE_LIMIT};
...
pub fn query(deps: Deps, env: Env, msg: QueryMsg) -> Result<Binary, ContractError> {
    match msg {
        ...
        QueryMsg::IsFeeExpected { lp_token: _, reward } => {
            ...
            let is_fee_expected = if reward_asset == config.oro_token {
