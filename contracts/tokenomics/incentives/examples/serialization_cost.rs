...
use oroswap::incentives::{RewardInfo, RewardType};
use oroswap_incentives::state::{PoolInfo, UserInfo};
...
fn main() {
    ...
    // Given that we allow 5 external rewards and 1 ORO reward per pool, we can estimate the following gas costs:
