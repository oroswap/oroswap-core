...
use oroswap::pair::ExecuteMsg as PairExecuteMsg;
use oroswap::querier::{query_balance, query_pair_info, query_token_balance};
use oroswap::router::SwapOperation;
use cosmwasm_std::{
...
///
/// * **operation** to perform (native or ORO swap with offer and ask asset information).
///
...
///
/// * **pair_contract** Oroswap pair contract for which the swap operation is performed.
///
