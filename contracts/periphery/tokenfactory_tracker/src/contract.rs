...
use oroswap::tokenfactory_tracker::{InstantiateMsg, SudoMsg};
...
pub fn sudo(deps: DepsMut, env: Env, msg: SudoMsg) -> Result<Response, ContractError> {
    match msg {
        ...
        // Balance tracking feature is crucial for Oroswap and Neutron DAOs thus we deliberately abuse SudoMsg::BlockBeforeSend
...
pub fn migrate(deps: DepsMut, _env: Env, msg: MigrateMsg) -> Result<Response, ContractError> {
    ...
    match (
        ...
        ("oroswap-tokenfactory-tracker", "1.0.0") => {
            let config = CONFIG.load(deps.storage)?;
...
mod tests {
    ...
    use oroswap::tokenfactory_tracker::QueryMsg;
