...
use oroswap::native_coin_registry::{CoinResponse, Config, ExecuteMsg, InstantiateMsg, QueryMsg};
use oroswap_native_coin_registry::error::ContractError;
...
fn proper_initialization() {
    ...
    let native_registry_code_id = store_coin_registry_code(&mut app);
